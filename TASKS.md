...
### [ ] TASK-153: `/watchlist add|remove|list` Telegram команда — пинить конкретные рынки
...
### [ ] TASK-154: Bet export CSV через `/export` Telegram команда
**Файл:** `internal/notifier/telegram_commands.go` (обновить)
...
### [ ] TASK-155: Forecast freshness guard — пропуск ставки если прогноз устарел >N часов
