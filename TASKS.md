...
### [ ] TASK-142: OpenMeteo snowfall direct signal — точный снежный прогноз через snowfall_sum
...
### [ ] TASK-143: `bot --validate` флаг — проверка конфига и API connectivity перед запуском
**Файл:** `cmd/bot/main.go` (обновить)
