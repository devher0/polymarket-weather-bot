...
### [ ] 2026-05-28 — TASK-138: Telegram /forecast команда — быстрый просмотр прогноза из Telegram
...
### [ ] 2026-05-28 — TASK-139: Win/loss streak detector — алерт при серии поражений
...
### [ ] 2026-05-28 — TASK-140: `dashboard freshness` — таблица свежести прогнозов
**Файл:** `cmd/dashboard/main.go` (обновить)
